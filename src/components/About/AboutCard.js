      ...
      <Card.Body>
        <blockquote className="blockquote mb-0" data-aos="zoom-in">
          <p style={{ textAlign: "justify"}}>
            Hi Everyone, I am <span className="primary-header">Neeraj Kumawat</span> from Jaipur, Rajasthan, India. I am a computer science graduate and a passionate programmer.
            <br />
            <br />
